...
const Details = () => {
  return (
    <>
      <div className=" rounded details border-red-700 border-2 h-auto md:h-[50vh] w-[90%] md:w-2/3 m-4 flex flex-col justify-between relative mx-auto overflow-visible px-4 py-4 rounded-tr-lg rounded-br-lg">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full gap-4">
          ...
          {/* Right (Text) */}
          <div className="border-red-700 border-2 rounded   bg-black h-auto md:h-[30vh] text-zinc-400 sarpanch-regular text-lg md:text-2xl p-6 md:p-10 w-full md:w-[70%] md:relative md:right-[-4%] rounded-tr-lg rounded-br-lg">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full mt-4 gap-4">
          ...
          {/* Right (Tagline) */}
          <div className="border-red-700 border-2 bg-black h-auto md:h-20 text-zinc-400 sarpanch-regular text-lg md:text-2xl pl-6 pt-4 md:pl-10 md:pt-5 w-full md:w-[70%] md:relative md:right-[-4%] rounded-tr-lg rounded-br-lg">
