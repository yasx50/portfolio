...
const ProjectCard = ({
  ...
  demoLink,
  githubLink,
  delay = 0 // Optional delay prop for staggered animations
}) => {
  ...
  return (
    <div
      ...
      className={`
        ...
        h-auto md:h-40 w-[90%] md:w-2/3 flex items-center mx-auto overflow-hidden
        px-4 py-2 rounded-lg shadow-lg mb-6 last:mb-0 p-6
    ...
    >
      ...
      <div className="w-[40%] h-full flex items-center justify-center overflow-hidden rounded-l-lg">
        <img
              ...
              <div className="flex space-x-2 justify-center">
                ...
                {techIcons.slice(0, 4).map((IconComponent, idx) => (
                  <div 
                    ...
                    `}
                    style={{
                      transitionDelay: isVisible ? `${500 + (idx * 100)}ms` : '0ms'
                    }}
                  >
                    {IconComponent}
                  </div>
